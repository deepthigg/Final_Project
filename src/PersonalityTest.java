        ...
        public static void main(String[]args)
        {
            ...
            if (response.equals(yesresponse))
            {
                ...
                System.out.println("You are on your way home and as you come closer to your house, you see smoke coming from your neighbors house, and you hear the wails for your neighbours. You realize that there is afire and your neighbours are trapped. What do you do?  " +
                        "\n 1.You run into your house and gather your belongings and flee in case the fire comes to your house" +
                        "\n 2.You call the police and wait in front of the neighbours house till they arrive " +
                        "\n 3.You call the police then run into the neighbors house in hopes of rescuing someone");
                ...
                {
                    System.out.println(" mostly calm ");
                }
                ...
                {
                    System.out.println("Mostly nice but still needs work ");
                }
                ...
                {
                    System.out.println(" You are quite a neutral person, There is no on personality that solely identifies you. You are kind, calm, but also can be courageous and cold hearted when needed to. ");
                }
             }
                else
